...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         <b>Bill</b> &nbsp; <a href="{{route('admin.setting.create')}}" class="bg-primary text-white text-decoration-none" style="padding:8px 12px;margin-left:15px"><i class="fa fa-plus editable" style="font-size:15px;">&nbsp;ADD</i></a>
      </h1>
      <ol class="breadcrumb">
