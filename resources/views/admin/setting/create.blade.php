...
<div class="content-wrapper">
   ...
   <section class="content-header" style="display: flex; align-items: center;">
      <a href="{{ URL::to('/admin/setting') }}"><i class="fa fa-arrow-circle-left" style="font-size:35px;color:red"></i></a>
      ...
      <div class="row">
         ...
         <div class="col-12">
            ...
            <div class="box box-info">
               ...
               {!! Form::open(['method'=>'POST', 'action'=> 'AdminSettingController@store','files'=>true,'class'=>'form-horizontal', 'name'=>'addsettingform']) !!}
               @csrf
               <div class="box-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="text" name="contact" id="contact" class="form-control border border-dark mb-2" placeholder="Enter contact no">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="text" class="form-control" name="gst_name" id="gst_name" placeholder="Enter Gst Name">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="text" class="form-control" name="invoice_code" id="invoice_code" placeholder="Enter invoice codes">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="number" class="form-control" name="invoice_series" id="invoice_series" placeholder="Enter invoice series">
...
<script>
   $(function() {
      $("form[name='addsettingform']").validate({
         rules: {
            hotel_id: {
               required: true,
            },
