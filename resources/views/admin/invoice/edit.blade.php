   ...
   <section class="content">
      <div class="row">
         ...
         <div class="col-12" style="margin-left:10px; margin-right:10px;">
            ...
            <div class="box box-info" style="margin-left:15px; margin-right:15px;">
                     ...
                     <div class="accordion-content">
                        ...
                        <div class="box-body">
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <select name="hotel_id" id="hotel_id" class="custom-select form-control form-control-rounded" onchange="getDetail(this.value)" readonly>
                                    @foreach($hotels as $hotel)
                                    <option value="{{$hotel->id}}" {{$invoice->hotel_id == $hotel->id ? 'selected' : ''}}>{{$hotel->hotel_name}}</option>
                                    @endforeach
                                 </select>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="invoice_no" id="invoice_no" class="form-control border border-dark mb-2" placeholder="Enter Invoice number" value="{{$invoice->invoice_no}}" readonly>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <input type="date" name="invoice_date" id="invoice_date" class="form-control border border-dark mb-2" value="{{$invoice->invoice_date}}" required>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" class="form-control" name="guest_name1" id="guest_name1" placeholder="Enter Guest Name 1" value="{{$invoice->guest_name1}}" required>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" class="form-control" name="guest_name2" id="guest_name2" placeholder="Enter Guest Name 2" value="{{$invoice->guest_name2}}">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <input type="email" name="guest_email" id="guest_email" class="form-control border border-dark mb-2" value="{{$invoice->guest_email}}" placeholder="Enter email" required>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <input type="number" name="guest_mobile" id="guest_mobile" class="form-control border border-dark mb-2" value="{{$invoice->guest_mobile}}" placeholder="Enter mobile no" required>
               ...
               <div class="box-body" id="addInvoiceDetail">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-2">
                        ...
                        <select name="type" id="type" class="custom-select form-control form-control-rounded" onchange="toggleSelectDivs(this.value)" required>
                     ...
                     <div id="extra_select" style="display:none;">
                        <div class="col-sm-2">
                           ...
                           <select name="extra_id" id="extra_id" class="custom-select form-control form-control-rounded" onchange="getExtraDetail(this.value)">
               ...
               <div class="box-body" id="editInvoiceDetail{{$invoicedata->id}}" style="display:none;">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-2">
                        <label for="type" class="control-label">Type :</label>
                        <select name="type" id="type{{$invoicedata->id}}" class="custom-select form-control form-control-rounded" onchange="toggleSelectDivs(this.value)" required readonly>
                           <option value="">Type</option>
                           <option value="room" {{ $invoicedata->type == 'room' ? 'selected' : '' }}>Room</option>
                           <option value="extra" {{ $invoicedata->type == 'extra' ? 'selected' : '' }}>Extra Service</option>
                        </select>
                        @if($errors->has('type'))
                        <div class="error text-danger">{{ $errors->first('type') }}</div>
                        @endif
                     ...
                     <div id="edit_extra_select{{$invoicedata->id}}" style="display:none;">
                        <div class="col-sm-2">
                           <label for="extra_id" class="control-label">Extra services :</label>
                           <select name="extra_id" id="extra_id{{$invoicedata->id}}" class="custom-select form-control form-control-rounded" onchange="editgetExtraDetail(this.value,{{$invoicedata->id}})">
                              <option value="">Select Service</option>
                              @foreach($extras as $extra)
                              <option value="{{$extra->id}}" {{ $invoicedata->extra_id == $extra->id ? 'selected' : '' }}>{{$extra->name}}</option>
                              @endforeach
                           </select>
                           @if($errors->has('room_no'))
                           <div class="error text-danger">{{ $errors->first('room_no') }}</div>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-2">
                        <label for="days" class="control-label">No. of days/quntity:</label>
                        <input type="number" class="form-control" name="days" id="days{{$invoicedata->id}}" placeholder="Enter days" value="{{ $invoicedata->days }}" oninput="editcalculateAmounts({{$invoicedata->id}})" required>
                        @if($errors->has('days'))
                        <div class="error text-danger">{{ $errors->first('days') }}</div>
                        @endif
                     </div>
            ...
            <div class="box box-info" style="margin-left:15px; margin-right:15px;">
               <div class="box-header with-border">
                  <a href="{{route('admin.invoice.pdf', $invoice->id)}}" class="bg-success text-white text-decoration-none" style="padding:8px 12px;margin-left:15px;font-size:20px">Generate Bill</a>
                  @if($invoice->file != '')
                  <a href="{{asset('invoices/'.$invoice->file)}}" target="_blank" class="bg-info text-white text-decoration-none" style="padding:8px 12px;margin-left:15px;font-size:20px">View Bill</a>
                  @endif
               </div>
