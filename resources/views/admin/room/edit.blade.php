      ...
      <div class="row">
         ...
         <div class="col-12">
            ...
            <div class="box box-info">
               ...
               <!-- /.box-header -->
               <!-- form start -->
               {!! Form::model($room, ['method'=>'PATCH', 'action'=> ['AdminRoomController@update', $room->id],'files'=>true,'class'=>'form-horizontal', 'name'=>'editRoomForm']) !!}
               @csrf
               <div class="box-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="number" name="room_no" id="room_no" class="form-control border border-dark mb-2" placeholder="Enter Room No" value="{{$room->room_no}}">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <select name="category_id" id="category_id" class="custom-select form-control form-control-rounded" required>
                           ...
                           <option value="{{$category->id}}" {{$room->category_id == $category->id ? 'selected' : ''}}>{{$category->c_name}}</option>
                           @endforeach
                        </select>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="number" class="form-control" name="gst_percentage" id="gst_percentage" placeholder="Enter GST Percentage" value="{{$room->gst_percentage}}">
...
<script>
   $(function() {
      $("form[name='editRoomForm']").validate({
         rules: {
            hotel_id: {
               required: true,
            },
